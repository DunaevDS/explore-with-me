...
import static ru.practicum.constant.Constant.EVENT_URI;
...
public class EventStatService {
    ...
    public Map<Long, Long> getEventsViews(List<Long> events) {
        ...
        requestDto.setStart(LocalDateTime.now().minusDays(100).format(FORMATTER));
        requestDto.setEnd(LocalDateTime.now().format(FORMATTER));
        ...
        log.info("выходим из getEventsViews");
        return eventsViews;
    }
}
